...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var results=[];var images=",["escape",["macro",121],8,16],";for(i=0;i\u003C3;i++)results.push(",["escape",["macro",121],8,16],"[i].id);return results})();"]
    },{
      "function":"__f",
      "vtp_component":"PATH",
      "vtp_defaultPages":["list"]
  ...
  "tags":[{
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Efbq(\"track\",\"ViewContent\",{content_name:",["escape",["macro",92],8,16],"});\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":85
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Etry{sessionStorage.setItem(\"ItemMaxSizeLoad\",",["escape",["macro",94],8,16],")}catch(a){};\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":534
  ...
  "rules":[
    [["if",0],["add",0,89,90,91,92,93,94,95,96,97,98,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117,118,119,120,121,122,123]],
    [["if",4,5],["add",2]],
    [["if",6],["add",3]],
    [["if",7],["add",4,130]],
    [["if",8],["add",5]],
    ...
    [["if",24,25],["add",22,42,50,83,135,142]],
    [["if",26],["add",23]],
    [["if",27],["add",24]],
    [["if",5,28],["add",25]],
    [["if",5,29],["add",26]],
    ...
    [["if",5,50],["add",39]],
    [["if",51],["add",40]],
    [["if",0,52,53],["add",41,80,137]],
    [["if",5,54],["add",44]],
    [["if",0,1],["add",45,127],["block",0,79]],
    [["if",1,5,55],["add",46,129]],
    [["if",56],["add",47]],
    [["if",23,57],["add",49,53,56,57,81,85,86,133,138]],
    [["if",0,58],["add",51,62]],
    [["if",0,59],["add",52]],
    [["if",60],["add",55]],
    ...
    [["if",24,85],["add",84]],
    [["if",5,86,87],["add",87]],
    [["if",42,87,88,89],["add",88]],
    [["if",0,87],["add",124]],
    [["if",23,24,90],["unless",91,92],["add",126]],
    [["if",1,93,94],["add",128]],
    [["if",19,24],["add",130]],
    [["if",15,24,95],["add",131]],
    [["if",23,24],["add",132]],
    [["if",23,57,96],["add",134]],
    [["if",15,24,97],["add",136]],
    [["if",33,98,99,101],["unless",100],["add",139]],
    [["if",33,98,99,102],["unless",100],["add",140]],
    [["if",33,34,35],["block",1]],
    [["if",0,47],["block",35,41,125,128,129]],
    [["if",0,48],["block",36,40,42,43,44,48,53,56,57,128,130,131,132,133,135,136]]]
},
...
function Ys(a,b){}var Z={b:{}};Z.b.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.g="ctv";Z.__ctv.h=!0;Z.__ctv.priorityOverride=0})(function(){return"441"})}();
...
"set",t);f(g+"require",b.vtp_optimizeContainerId,{dataLayer:"dataLayer"});f(b.vtp_gtmOnSuccess);f(g+"require","render");a||(a=!0,S(r,function(){return dk().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure));var u=T("dataLayer"),v=u&&u.hide;v&&(v.end||!0===v["GTM-W6LTGTD"])&&(v[b.vtp_optimizeContainerId]=!0)}else N(b.vtp_gtmOnFailure)})}();
